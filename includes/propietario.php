    ...
    public function login($cedula, $password) {
        if ($cedula!="" && $password!="") {
            ...
            if ($result['suceed'] == 'true' && count($result['data']) > 0) {
                ...
                unset($result['data']);
                $result['suceed'] = false;
                $result['mensaje'] = "Contraseña inválida.";
                return $result;
                ...
                unset($result['data']);
                $result['suceed'] = false;
                $result['mensaje'] = "Código de usuario no registrado.";
    ...
    public function recuperarContraSena($cedula) {
        if ($cedula!="") {
            ...
            if ($result['suceed'] == 'true' && count($result['data']) > 0) {
                ...
                $result=false;
                $result['error']="Código de usuario no registrado. Si considera
        ...
        if ($propieatarios['suceed'] && count($propieatarios['data'])>0) {
            ...
            if (file_exists($template)) {
                ...
                foreach ($propieatarios['data'] as $propietario) {
                    ...
                    //$destinatario = 'administracion@ayeasoc.com.ve';
