...
if (isset($_GET['codinm'])) {
    ...
    $mensaje = "<strong style='color:rgb(153,0,0)'>Actualización inmueble ".$codinm."</strong><br>";
} else {
    $mensaje = "<strong style='color:rgb(153,0,0)'>Proceso de Actualización Ejecutado</strong><br />";
...
echo "procesar cuentas inmuebles (" . count($lineas) . ")<br />";
...
// <editor-fold defaultstate="collapsed" desc="Cuentas Inmueble">
...
$mensaje = '<div style="background-color:rgb(153,0,0);padding:50px 0 50px;">'
        ...
        . '<img alt="Tu Condominio Fácil" src="http://www.sigroup.com.ve/images/logo.png" id="logo" width="216" height="60"></div>'
...
$mensaje.= '</div><div style="display: block;width: 60px;height: 2px;margin:10px 0;background-color:rgb(153,0,0);position: relative;float:left"></div>'
...
$r = $mail->enviar_email("[sincronización web] ".NOMBRE_APLICACION." ".$fecha,$mensaje, "", 'sigroupvzla@gmail.com',"");
